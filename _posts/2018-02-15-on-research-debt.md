...
<figure>
  <img src="{{ site.baseurl }}{% link /assets/img/interest_vector_2d.svg %}" alt="2D interest space" style="min-width:60%;">
...
<figure>
  <img src="{{ site.baseurl }}{% link /assets/img/iq_distribution.svg %}" alt="IQ distribution" style="min-width:80%;">
